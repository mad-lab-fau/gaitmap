...
submodule (for example see `gaitmap_mad/src/gaitmap_mad/stride_segmentation/hmm`)
...
(e.g. `gaitmap_mad/src/gaitmap_mad/stride_segmentation/hmm`), that is not imported anywhere else in the library.
