...
class TestAlgorithmMixin:
    ...
    def test_all_parameters_documented(self) -> None:
    ...
    def test_all_attributes_documented(self, after_action_instance) -> None:
    ...
    def test_action_method_returns_self(self, after_action_instance) -> None:
    ...
    def test_set_params_valid(self, valid_instance) -> None:
    ...
    def test_set_params_invalid(self, valid_instance) -> None:
        instance = valid_instance.clone()
    ...
    def test_json_roundtrip(self, valid_instance) -> None:
        instance = valid_instance.clone()
