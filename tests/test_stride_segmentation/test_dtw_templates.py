...
class TestSerialize:
    ...
    def test_different_dtypes(self, dtype) -> None:
    ...
    def test_index_order_long_dfs(self) -> None:
...
class TestTemplateBaseClass:
    def test_template_provided(self) -> None:
    ...
    def test_no_valid_info_provided(self) -> None:
    ...
    def test_use_columns_array(self) -> None:
    ...
    def test_use_columns_dataframe(self) -> None:
        template = np.stack((np.arange(10), np.arange(10, 20))).T
    ...
    def test_use_columns_wrong_dim(self) -> None:
        template = np.arange(10)
    ...
    def test_get_data_applies_scaling(self) -> None:
...
class TestCreateTemplate:
    def test_create_template_simple(self) -> None:
        template = np.arange(10)
    ...
    def test_create_template_use_col(self) -> None:
        template = np.stack((np.arange(10), np.arange(10, 20))).T
        template = pd.DataFrame(template, columns=["col_1", "col_2"])
        sampling_rate_hz = 100
        use_cols = ("col_1",)
...
class TestCreateInterpolatedTemplate:
    ...
    def test_create_interpolated_template_single_dataset(self) -> None:
    ...
    def test_create_interpolated_template_dataset_list(self) -> None:
    ...
    def test_create_interpolated_template_different_indices(self) -> None:
    ...
    def test_create_interpolated_template_calculates_mean(self) -> None:
    ...
    def test_create_interpolated_mean_length_over_input_sequences_template(self) -> None:
    ...
    def test_create_interpolated_fixed_length_template_upsample(self) -> None:
    ...
    def test_create_interpolated_fixed_length_template_downsample(self) -> None:
    ...
    def test_create_interpolated_template_check_multisensordataset_exception(self) -> None:
