...
class TestConvertAxes:
    ...
    def test_rotate_multisensor_left(self) -> None:
    ...
    def test_rotate_multisensor_right(self) -> None:
    ...
    def test_rotate_multisensor_dict(self) -> None:
