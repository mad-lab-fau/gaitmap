...
class TestSlidingWindow:
    ...
    def test_invalid_inputs_overlap(self) -> None:
    ...
    def test_invalid_inputs_window_size(self) -> None:
    ...
    def test_invalid_inputs_window_size_2(self) -> None:
    ...
    def test_view_of_array(self) -> None:
    ...
    def test_copy_of_array_with_padding(self) -> None:
    ...
    def test_nan_padding_of_type_nan(self) -> None:
        """Test if output a copy of input data."""
    ...
    def test_sliding_window_1D_without_without_padding(self) -> None:
    ...
    def test_sliding_window_1D_with_padding(self) -> None:
    ...
    def test_sliding_window_1D_without_padding(self) -> None:
    ...
    def test_sliding_window_1D_asym_with_padding(self) -> None:
    ...
    def test_sliding_window_1D_asym_without_padding(self) -> None:
    ...
    def test_sliding_window_1D_no_overlap_without_padding(self) -> None:
    ...
    def test_sliding_window_1D_no_overlap_with_padding(self) -> None:
    ...
    def test_sliding_window_1D_asym_overlap_with_padding(self) -> None:
    ...
    def test_sliding_window_3D_without_edge_case(self) -> None:
    ...
    def test_sliding_window_3D_with_padding(self) -> None:
    ...
    def test_sliding_window_3D_asym_with_padding(self) -> None:
    ...
    def test_sliding_window_5D_without_padding(self) -> None:
...
class TestBoolArrayToStartEndArray:
    ...
    def test_edges_array(self) -> None:
    ...
    def test_bool_value_array(self) -> None:
    ...
    def test_float_value_array(self) -> None:
...
class TestStartEndArrayToBoolArray:
    ...
    def test_simple_input_no_padding(self) -> None:
    ...
    def test_simple_input_1d_no_padding(self) -> None:
    ...
    def test_simple_input_with_padding(self) -> None:
        input_array = np.array([[2, 3], [5, 9]])
    ...
    def test_length_unsorted(self, reverse) -> None:
    ...
    def test_overlapping_input_with_padding(self) -> None:
    ...
    def test_correct_output_dtype(self) -> None:
        input_array = np.array([[2, 3], [5, 9]])
        output_array = start_end_array_to_bool_array(input_array)
        assert output_array.dtype == "bool"

    def test_bool_array_round_trip(self) -> None:
        input_array = np.array([[2, 3], [5, 9]])
        output_array = start_end_array_to_bool_array(input_array)
...
class TestLocalMinimaBelowThreshold:
    ...
    def test_split_array_simple(self, data, result) -> None:
    ...
    def test_find_extrema(self, data, threshold, results) -> None:
...
class TestFindMinRadius:
    def test_invalid_method_name_error(self) -> None:
    ...
    def test_simple(self, method, ex_value) -> None:
    ...
    @pytest.mark.parametrize(("method", "ex_value"), [("min", -1), ("max", 1)])
    def test_multiple_matches(self, method, ex_value) -> None:
    ...
    def test_edge_case_end(self) -> None:
    ...
    def test_edge_case_start(self) -> None:
    ...
    def test_tuple_input_identical_to_single_input(self, radius) -> None:
    ...
    def test_non_equal_left_right_radius(self) -> None:
    ...
    def test_non_equal_radius_edgecase(self) -> None:
        data = np.array([0, 2, 0, 0, 0, 1, 0, 0])
        indices = np.array([2, 3, 4])
        radius = (3, 5)
...
class TestMultiArrayInterpolate:
    ...
    def select_kind(self, request) -> None:
...
class TestMergeIntervals:
    ...
    def test_merge_intervals(self, input_array, output_array, gap_size) -> None:
...
class TestIterateRegionData:
    ...
    def test_data_different_col_order(self) -> None:
