...
class TestForwardDirectionSignAlignment:
    ...
    def test_invalid_axis_combination(self) -> None:
    ...
    def test_invalid_ori_method(self) -> None:
    ...
    def test_invalid_pos_method(self) -> None:
    ...
    def test_no_rotation(self, healthy_example_imu_data) -> None:
    ...
    def test_flip_rotation(self, healthy_example_imu_data) -> None:
