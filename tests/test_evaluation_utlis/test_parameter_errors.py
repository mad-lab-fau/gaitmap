...
class TestCalculateAggregatedParameterErrors:
    ...
    def test_invalid_input(self, input_param, ground_truth, expected_error) -> None:
    ...
    def test_valid_single_sensor_input(self, input_param, ground_truth, expectation) -> None:
    ...
    def test_valid_multi_sensor_input(self, input_param, ground_truth, sensor_names, expectations) -> None:
        output_normal = calculate_aggregated_parameter_errors(
            predicted_parameter=input_param, reference_parameter=ground_truth
        )
    ...
    def test_calculate_not_per_sensor_input(self, input_param, ground_truth, expectation) -> None:
        output_normal = calculate_aggregated_parameter_errors(
    ...
    def test_n_strides_missing(self, per_sensor) -> None:
    ...
    def test_n_strides_missing_multi_param(self, single_sensor) -> None:
        if single_sensor:
    ...
    def test_calculate_per_sensor(self) -> None:
...
class TestCalculateParameterErrors:
    ...
    def test_simple_non_dict(self) -> None:
        predicted_parameter = _create_valid_input(
