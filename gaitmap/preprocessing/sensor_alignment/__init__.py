...
from gaitmap.preprocessing.sensor_alignment._heading_alignment import HeadingAlignment
...
__all__ = ["align_dataset_to_gravity", "align_heading_of_sensors", "PcaAlignment", "HeadingAlignment"]
