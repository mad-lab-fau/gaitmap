...
from gaitmap.stride_segmentation.dtw_templates.templates import create_dtw_template, create_interpolated_dtw_template, DtwTemplate, BarthOriginalTemplate
